...
public class DirectProducerTest {
    ...
    @Autowired
    private DirectProducer fanoutProducer;

    @Test
    public void send() {
        fanoutProducer.send(RabbitConstant.ExchangeDirect, RabbitConstant.RoutingKeyA,"你好,我是send a");
        fanoutProducer.send(RabbitConstant.ExchangeDirect, RabbitConstant.RoutingKeyB,"你好,我是send b");
    }
    ...
    public void testSend() {
        ...
        fanoutProducer.confirmSend(RabbitConstant.ExchangeDirect,RabbitConstant.RoutingKeyA,"你好，我是confimSend a",confirmCallback ,returnCallback);
        fanoutProducer.confirmSend(RabbitConstant.ExchangeDirect,RabbitConstant.RoutingKeyB,"你好，我是confimSend b",confirmCallback ,returnCallback);
    }
}