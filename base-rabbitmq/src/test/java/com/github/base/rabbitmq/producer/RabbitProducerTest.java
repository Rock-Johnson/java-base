...
public  class RabbitProducerTest {
    ...
    @Autowired
    private RabbitProducer producerApi;

    @Test
    public void send() {
        producerApi.send(RabbitConstant.QueueSimple,"你好,我是send");
    }
    ...
    public void testSend() {
        ...
        producerApi.confirmSend(RabbitConstant.QueueSimple,"你好，我是confimSend",confirmCallback ,returnCallback);
    }
