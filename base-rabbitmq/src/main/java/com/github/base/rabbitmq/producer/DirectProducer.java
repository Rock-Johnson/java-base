...
public class DirectProducer {
     ...
     */
    public void confirmSend(String exchange, String routingKey,String msg, RabbitTemplate.ConfirmCallback confirmCallback,RabbitTemplate.ReturnCallback returnCallback){
        // 构建回调返回的数据
